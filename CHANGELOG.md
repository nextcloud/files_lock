...
- [stable30] fix: Use icons instead of avatar for locking indication [#472](https://github.com/nextcloud/files_lock/pull/472)

### Fixed

- [stable30] Allow force unlock of automated client locks [#441](https://github.com/nextcloud/files_lock/pull/441)
- [stable30] fix: Use proper user when unlocking an app locked file with occ [#465](https://github.com/nextcloud/files_lock/pull/465)
...
- [stable30] fix(ci): litmus test with current upload-artifact [#371](https://github.com/nextcloud/files_lock/pull/371)
- [stable30] chore(dev-deps): Bump nextcloud/ocp package @juliusknorr [#373](https://github.com/nextcloud/files_lock/pull/373)
